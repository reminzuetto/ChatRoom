...
function appendMessage(msg, type) {
  ...
  // Kiểm tra nếu tin nhắn gần đây có cùng người gửi
  if (recentMessages[msg.user] && recentMessages[msg.user] === msg.message) {
    // Nếu tin nhắn gần đây từ cùng người gửi, không tạo thẻ người gửi mới
    mainDiv.classList.add("same-user");
  } else {
    // Nếu không, cập nhật người gửi và lưu trữ tin nhắn
    recentMessages[msg.user] = msg.message;
  }
