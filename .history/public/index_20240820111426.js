...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (name && room) {
    ...
    const roomDisplay = document.getElementsByClassName("dropdown-button");
    roomDisplay[0].textContent = room;
    const nameDisplay = document.getElementsByClassName("dropdown-item");
    nameDisplay[0].textContent = name;
  }
});
